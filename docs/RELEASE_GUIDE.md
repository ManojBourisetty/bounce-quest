...
| 1024×1024 icon | iOS App Store | ✅ `store-assets/ios-icon-1024.png` |
| Feature graphic 1024×500 | Play Store listing | ❌ needs creating |
| Phone screenshots (multiple) | Both stores | ✅ `store-assets/screenshots/` (App Store 6.7" + Play Store) |
...
See `store-assets/README.md` for details on the generated icon and
screenshots, and what's still left (feature graphic, iPad screenshots,
optionally re-shooting on a real device before final submission).
